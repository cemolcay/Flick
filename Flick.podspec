#
#  Be sure to run `pod spec lint Flick.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Flick"
  s.version      = "0.0.1"
  s.summary      = "A smart swipe gesture with direction, duration, velocity and force properties."
...
In your gesture handler, read the data directly from gesture reference.
  ...
  s.source       = { :git => "https://github.com/cemolcay/Flick.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Flick/FlickGestureRecognizer.swift"
